    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          {message && <div className="text-green-500 text-center bg-green-50 p-3 rounded-md border border-green-200">{message}</div>}
          <div>
            <input
              type="email"
              required
          ...
          <div>
            <button
              type="submit"
              className="w-full py-3 px-4 bg-green-600 hover:bg-green-700 rounded-lg text-white font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
            >
