      ...
      {!hideText && (
        <div className="flex flex-col">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-gray-600">({userData.plan || 'Terapeuta Iniciante'})</span>
          </div>
          {tokenUsage && (
            <div className="text-xs">
              <span className="text-green-600">{tokenUsage.totalTokens - tokenUsage.usedTokens}</span>
